 ...
 */
router.post('/',verifyToken,allowedTo("admin","instructor"),addQuestin);
/**
 * @swagger
 * /api/question:
 *   get:
 ...
 */
router.put('/:id',verifyToken, allowedTo("admin","instructor"), updatedQuestion);
/**
 * @swagger
 * /api/question/{id}:
 *   delete:
 ...
 */
router.delete('/:id',verifyToken,allowedTo("admin","instructor"), deleteQuestion);
